...
var LinkedListCollections = /** @class */ (function (_super) {
    __extends(LinkedListCollections, _super);
    function LinkedListCollections() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.head = null;
        return _this;
    }
    LinkedListCollections.prototype.add = function (data) {
    ...
    LinkedListCollections.prototype.at = function (index) {
        if (!this.head) {
    ...
    LinkedListCollections.prototype.print = function () {
        if (!this.head)
            return;
        var node = this.head;
        while (node) {
